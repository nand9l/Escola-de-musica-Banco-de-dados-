-- Inserindo registros na tabela composicao_sinfonica
INSERT INTO `mydb`.`composicao_sinfonica` (`idsinfonia`, `data_composta`, `nome`, `compositor`) 
VALUES 
...
INSERT INTO `mydb`.`funcao` (`idfuncao`, `funcao_descricao`) 
VALUES 
(1, 'Maestro'),
...
INSERT INTO `mydb`.`instrumento_musical` (`idinstrumentos`, `nome`) 
VALUES 
(1, 'Violino'),
(2, 'Viola'),
(3, 'Violoncelo'),
